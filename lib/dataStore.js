...
// **緊急修正: KVストレージを完全無効化してファイルベースに統一**
let kvStore = null
let useKV = false

// KVストレージを強制的に無効化（データ統一のため）
console.log('⚠️ 緊急修正: KVストレージを無効化してファイルベースに統一')
