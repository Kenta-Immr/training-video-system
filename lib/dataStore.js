    ...
    if (useKV) {
      ...
      try {
        ...
        if (success) {
          ...
          console.error('KVへの保存に失敗しました')
          throw new Error('KV保存失敗')
        }
      } catch (error) {
        console.error('KV保存中にエラーが発生:', error)
        throw error
      }
    }
    ...
    if (useKV) {
      ...
      try {
        ...
        if (success) {
          ...
          console.error('KVへのユーザーデータ保存に失敗しました')
          throw new Error('KVユーザー保存失敗')
        }
      } catch (error) {
        console.error('KVユーザー保存中にエラーが発生:', error)
        throw error
      }
    }
    ...
    if (useKV) {
      ...
      try {
        ...
        if (success) {
          ...
          console.error('KVへのグループデータ保存に失敗しました')
          throw new Error('KVグループ保存失敗')
        }
      } catch (error) {
        console.error('KVグループ保存中にエラーが発生:', error)
        throw error
      }
    }
