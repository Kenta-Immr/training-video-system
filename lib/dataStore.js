...
// **緊急対応: 本番環境でもKVが使用できない場合はファイルベースを使用**
// データファイルのパス（KVが利用できない場合は/tmp使用）
const DATA_DIR = (isVercel && useKV) ? '/tmp' : path.join(process.cwd(), 'data')
